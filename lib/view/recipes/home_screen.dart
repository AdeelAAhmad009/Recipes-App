          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () =>
                      Get.to(const AllRecipes(), transition: Transition.upToDown, duration: const Duration(milliseconds: 800)),
                  child: const Row(
                    children: [
                      Text(
                        "See All",
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) => InkWell(
                onTap: () {
                  setState(() {
                    currentIndex = index;
                    // pageController.animateToPage(currentIndex, duration: const Duration(milliseconds: 500), curve: Curves.ease);
                  });
                },
                child: Container(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 15,
                        backgroundImage: AssetImage("assets/images/ff.jpg"),
                      ),
                      SizedBox(width: 5),
                      Text(
                        "Name",
